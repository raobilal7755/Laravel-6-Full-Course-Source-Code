...
<html lang="en">
  ...
  <body class="bg-dark">
    ...
    <h1 class="bg-danger text-white p-4 text-center">Form Validation in Laravel Method 1</h1>
    ...
    <div class="container">
        ...
        <form action="submitform" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" name="password" id="" class="form-control" placeholder="Enter your passwrod " >
            </div>
            <br>
